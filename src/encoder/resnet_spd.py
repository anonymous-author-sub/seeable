"""Implementation of SPD-Conv for resnet familly in pytorch

[1] Kaiming He, Xiangyu Zhang, Shaoqing Ren, Jian Sun.
    Deep Residual Learning for Image Recognition
    https://arxiv.org/abs/1512.03385v1

[2] Raja Sunkara and Tie Luo
...
class ResNetSPD(nn.Module):
    def __init__(self, block, num_block, num_classes=100):
        ...
        )  # Here in_channels = 64, and num_block[0] = 64 and s = 1
...
def resnet34SPD():
    return ResNetSPD(BasicBlock, [3, 4, 6, 3])


def resnet50SPD():
    """return a ResNetSPD 50 object"""
    return ResNetSPD(BottleNeck, [3, 4, 6, 3])


def resnet101SPD():
    """return a ResNetSPD 101 object"""
    return ResNetSPD(BottleNeck, [3, 4, 23, 3])


def resnet152SPD():
    """return a ResNetSPD 152 object"""
    return ResNetSPD(BottleNeck, [3, 8, 36, 3])
