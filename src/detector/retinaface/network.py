...
class RetinaFace(nn.Module):
    def __init__(
        ...
        super().__init__()
        assert pretrained is False, "pretrained==True is not supported"
        if name == "Resnet50":
            # backbone = models.resnet50(pretrained=pretrained)
            # v0.13 : weights=None or nothing
        ...
        self.body = _utils.IntermediateLayerGetter(backbone, return_layers)  # type: ignore
